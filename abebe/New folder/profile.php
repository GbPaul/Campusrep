...
while($row = mysql_fetch_array($result))
  {
	  if($row["userid"] != $_SESSION["studentaccountid"] )
{ 
$img[$i] = $row["image"];
$uid[$i] = $row["userid"];
$i++;
  ...
  $result = mysql_query("SELECT * FROM studentaccount where id");  

$strec = mysql_query("SELECT * FROM studentaccount WHERE email='$_SESSION[logid]' ");

while($row = mysql_fetch_array($strec))
  {
$_SESSION["studentaccountid"] =  $row["id"];

  }

$colrec = mysql_query("SELECT * FROM profile WHERE userid='$_SESSION[studentaccountid]' ");
...
$acrec1 = mysql_query("SELECT * FROM studentaccount WHERE id='$uid[0]' ");
...
$gen1= $row["iam"];
  ...
  $acrec2 = mysql_query("SELECT * FROM studentaccount WHERE id='$uid[1]' ");
...
$gen2= $row["iam"];
  ...
  $acrec3 = mysql_query("SELECT * FROM studentaccount WHERE id='$uid[2]' ");
...
$gen3= $row["iam"];
  ...
  $acrec4 = mysql_query("SELECT * FROM studentaccount WHERE id='$uid[3]' ");
...
<!-- body  content -->
  ...
  <tr>
    ...
    <td width="55%" rowspan="9" valign="top"><table width="100%" border="1">
        ...
        <tr>
          <td><strong>Number of  new visitors:
              <?php
if(isset($_SESSION['views']))
 ...
 ?>
  ...
  <tr>
    <td height="21" colspan="2" align="center" valign="top" bgcolor="#CCCCCC"><strong><a href="viewall.php">View</a></strong></td>
  </tr>
  <tr>
    <td height="36" bgcolor="#CCCCCC" align="center"><img src="images/harnosand.jpg" alt="cannot find image " width="77" height="75" /></td>
    <td height="36" bgcolor="#CCCCCC" align="center"><img src="images/ostersund.jpg" alt=" cannot find image" width="96" height="96" /></td>
  </tr>
  <tr>
    <td height="36" bgcolor="#CCCCCC" align="center"><img src="images/umea.jpg" alt="cannot find" width="78" height="78" /></td>
    <td height="36" bgcolor="#CCCCCC"><img src="images/umea.jpg" alt="" width="96" height="74" /></td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#CCCCCC" align="center"><strong>View Album</strong></td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#CCCCCC"><strong><u>University Admission</u></strong></td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#CCCCCC" align="center"  ><a href="http://www.miun.se/sv/utbildning/Hitta-din-utbildning/Program/" ><img src="images/sundsvall.jpg" width="173" height="185" /></a></td>
  </tr>
  </table>
