...
$sql="INSERT INTO studentaccount(firstname,lastname,email,password,confirmpassword,iam,dob)
VALUES
('$_POST[firstname]','$_POST[lastname]','$_POST[email]','$_POST[pass]','$_POST[confirmpassword]','$_POST[iam]','$dob')";
...
<tr>
	<td width="70%">
		<img src="images/left1.png" width="518" height="136" border="0" alt=" cant open ">
		<h1>Meet New Friends </h1>

		<table width=100%>
        
		<tr valign=top align=center>
			<td><a href=""><img src="<?php echo $img[0] ; ?>" width="100" height="150" border="0" alt="put image "></a><br></td>
			<td><a href=""><img src="<?php echo $img[1] ; ?>" width="100" height="150" border="0" alt=" put image here"></a><br></td>
		...
		<h1>About Us</h1>		
		The Campus networking website is an online community designed to  </td>
	<td width="30%" valign="top"> <img src="images/new.png" width="100%" height="199" alt=" put image here2" > </br>
